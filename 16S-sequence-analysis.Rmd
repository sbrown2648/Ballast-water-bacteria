...
Load dataframe containing pathway descriptions; this will be used to add descriptions to the pathways identified by DESeq2 later.
...
## Create PCoA of all MetaCyc results 
...
### Create dot plot of results - log2fold change
